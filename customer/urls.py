...
from customer.views import CustomerListView, CustomerCreateView, CustomerDetailView, CustomerUpdateView, CustomerDeleteView, ExportDataView

urlpatterns = [
    path('customer/export-data/', ExportDataView.as_view(), name='export_data'),
